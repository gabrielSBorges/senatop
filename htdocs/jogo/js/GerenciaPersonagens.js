    ...
    if (personagem.posicaoX >= proximidadeEsquerda && (personagem.posicaoX + personagem.largura) <= proximidadeDireita && personagem.posicaoY >= proximidadeCima && (personagem.posicaoY + personagem.altura) <= proximidadeBaixo) {
      ...
      switch (personagemTipo){
        case 0:
          ...
          mensagemLinha4 = mensagensNpcs[personagemID][3];
          mensagemLinha5 = mensagensNpcs[personagemID][4];
          break;
        case 1:
          ...
          mensagemLinha4 = mensagensDesafiantes[personagemID][3];
          mensagemLinha5 = mensagensDesafiantes[personagemID][4];
          break;
        case 2:
          ...
          mensagemLinha4 = mensagensProfessores[personagemID][3];
          mensagemLinha5 = mensagensProfessores[personagemID][4];
          break;
        case 3:
          ...
          mensagemLinha4 = mensagensElite[personagemID][3];
          mensagemLinha5 = mensagensElite[personagemID][4];
          break;
      }
      break;
    } else{
